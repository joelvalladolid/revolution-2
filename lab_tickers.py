"""
sp500_tickers.py
Obtiene los tickers del S&P 500 en tiempo real desde Wikipedia.
"""
...
def fetch_sp500_tickers_wiki_v2():
    ...
    try:
        ...
        print(f"[sp500] Fallo Wikipedia: {e}")
